<!DOCTYPE html>
<html lang="es" id="exe-page-1777396310863-b56oucrl1">
<head>
<meta charset="utf-8">
...
<title>11. Créditos y descarga | Exploramos los paisajes de España</title>
...
<div class="exe-content exe-export pre-js siteNav-hidden"><a href="#page-1777396310863-b56oucrl1" id="skipNav">Skip to content</a> <nav id="siteNav">
<ul>
...
<li> <a href="../html/10-guia-didactica.html" class="no-ch">10. Guía didáctica</a>
</li>
<li class="active"> <a href="../html/11-creditos-y-descarga.html" class="active no-ch">11. Créditos y descarga</a>
</li>
</ul>
</nav><main id="page-1777396310863-b56oucrl1" class="page"> 
<header class="main-header">
<div class="package-header"><p class="package-title">Exploramos los paisajes de España</p></div>
<div class="page-header"><h1 class="page-title">11. Créditos y descarga</h1></div>
</header><div id="page-content-page-1777396310863-b56oucrl1" class="page-content">
<article id="block-1777402064874-ngzblltlq" class="box">
...
<div id="idevice-1777402064874-ep000v62d" class="idevice_node text" data-idevice-path="../idevices/text/" data-idevice-type="text" data-idevice-component-type="json" data-idevice-json-data="{&quot;ideviceId&quot;:&quot;idevice-1777402064874-ep000v62d&quot;}">
<div class="exe-text-template">
    <p><strong>Autoría:</strong> Carmen María Damas Hermoso.<br /><strong>Título: </strong>Exploramos los paisajes de España.<br /><strong>Descripción:</strong> Situación de aprendizaje para 4º de Educación Primaria sobre los paisajes de España mediante investigación guiada y creación de una presentación digital.<br /><strong>Licencia:</strong> Creative Commons Reconocimiento-NoComercial-CompartirIgual 4.0.<br /><strong>Herramientas utilizadas:</strong> eXeLearning 3, Canva, Padlet, Symbaloo.</p>
<p download="Exploramos los paisajes de España.elpx"><a href="#" onclick="if(typeof downloadElpx==='function')downloadElpx();return false;" target="_blank" rel="noopener" title="">Descarga al archivo .elpx</a></p>
</div>
</div>
</div>
</article>
</div></main><div class="nav-buttons">
<a href="../html/10-guia-didactica.html" title="Anterior" class="nav-button nav-button-left"><span>Anterior</span></a>
